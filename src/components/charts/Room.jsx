...
const Room = () => {
  ...
  const availablePercent =
    (data.patients.room.available /
      (data.patients.room.available + data.patients.room.unavailable)) *
    100;
  const unavailablePercent =
    (data.patients.room.unavailable /
      (data.patients.room.available + data.patients.room.unavailable)) *
    100;
  ...
  return (
    <div className="max-xl:flex flex-col justify-between h-full w-full">
      ...
      {data.patients.room.available + data.patients.room.unavailable > 0 ? (
