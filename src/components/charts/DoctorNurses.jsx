...
const DoctorNurses = () => {
  ...
  return (
    <div className="flex w-full h-full">
      <div className="flex flex-col justify-between" style={{ width: `${(data.nurses.total / (data.nurses.total + data.doctors.total)) * 100}%` }}>
      ...
      <div className="flex flex-col justify-between" style={{ width: `${(data.doctors.total / (data.nurses.total + data.doctors.total)) * 100}%` }}>
        <div className="flex flex-col gap-[10px] pb-[24px] pl-[10px] h-full border-l border-black/[.2] border-dashed">
          <div className="flex gap-2 items-center text-xs text-black/[.5]">
