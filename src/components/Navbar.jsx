...
const Navbar = () => {
  ...
  return (
    <div className={`sticky top-[98px] pl-[30px] pr-[40px] ${isCollapse ? "w-[120px]":"w-[240px]"} duration-500`}>
      <div
        className={`flex ${
      ...
      >
        ...
        >
          {isCollapse ? (<BiChevronsRight className="min-w-[8px] min-h-[8px]" />):(<BiChevronsLeft className="min-w-[8px] min-h-[8px]" />)}
        </button>
      </div>
      ...
      <div className="flex h-full w-full mt-[45px]">
        <NavLink
          to={"/help-center"}
          className=" px-[16px] py-[12px] flex items-center gap-[13px] w-full rounded-full"
        >
