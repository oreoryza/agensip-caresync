...
const Auth = () => {
  ...
  return (
    <div className="flex justify-between p-[20px] w-screen h-screen">
      ...
      <div
        className="relative w-[54%] h-full bg-cover rounded-[20px] overflow-hidden"
      >
        <img src={isLogin ? loginImg : signupImg} alt="Doctors" className="object-cover h-full w-full" />
