  ...
  return (
    <div className="container overflow-hidden">
      ...
      <div className="flex flex-col bg-white/[.4] mt-[40px] rounded-[20px] overflow-hidden">
            ...
            <div className="relative flex flex-col gap-[24px] w-full">
              <div className="absolute flex flex-col gap-[24px] min-w-[500px] pointer-events-none">
                <button
                  ...
                  className="flex items-center gap-[12px] p-[5px] pr-[20px] bg-light-green rounded-full overflow-hidden w-fit pointer-events-auto hover:z-3 hover:scale-[1.05] duration-300"
                >
                ...
                <button
                  ...
                  className="flex items-center gap-[12px] p-[5px] pr-[20px] bg-light-yellow rounded-full overflow-hidden w-fit pointer-events-auto hover:z-3 hover:scale-[1.05] duration-300"
                >
            ...
            <div className="relative flex flex-col gap-[24px] w-full">
              <div className="absolute flex flex-col gap-[24px] min-w-[500px] pointer-events-none">
                ...
                <button
                  ...
                  className="flex items-center gap-[12px] p-[5px] pr-[20px] bg-light-blue rounded-full overflow-hidden w-fit pointer-events-auto hover:z-3 hover:scale-[1.05] duration-300"
                >
            ...
            <div className="relative flex flex-col gap-[24px] w-full">
              <div className="absolute flex flex-col gap-[24px] min-w-[500px] pointer-events-none">
                ...
                <button
                  ...
                  className="flex items-center gap-[12px] p-[5px] pr-[20px] bg-purple-200 rounded-full overflow-hidden w-fit pointer-events-auto hover:z-3 hover:scale-[1.05] duration-300"
                >
        ...
        <div className={`${isModalOpen && selectedSchedule ? "fadeIn" : "hidden"} fixed inset-0 bg-black/[.5] flex xl:items-center items-end justify-center z-50`}>
